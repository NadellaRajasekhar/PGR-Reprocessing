		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#compgrsuspenceproject1pgr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compgrsuspenceproject1pgr-display": {
								"semanticObject": "compgrsuspenceproject1pgr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pgr.suspence.project1pgr",
									"url": sap.ui.require.toUrl("com/pgr/suspence/project1pgr")
								}
							}
						}
					}
